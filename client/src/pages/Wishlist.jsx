...
const Wishlist = ({
  ...
  return (
    ...
    <div className="fixed inset-0 bg-opacity-30 backdrop-blur-sm bg-[#5AB2FF] flex justify-center items-center h-screen w-screen z-50" >
      ...
      <div className="bg-white rounded-lg p-4 w-full max-w-7xl overflow-y-auto max-h-[90vh] relative" style={{
      backgroundImage: `url(${backgroundImage})`,
      backgroundSize: 'cover',
      backgroundPosition: 'center',
    }}>
      <h1 className="text-3xl md:text-5xl mb-4 text-[#EC4898] font-comforter text-center ">Wishlist</h1>
        <button
